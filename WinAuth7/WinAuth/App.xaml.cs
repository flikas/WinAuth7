...
namespace WinAuth
{
    ...
    {
        private static AuthenticatorsViewModel authenticatorsViewModel = null;
        ...
        public static AuthenticatorsViewModel AuthenticatorsViewModel
        {
            get
            {
                if (authenticatorsViewModel == null)
                    authenticatorsViewModel = new AuthenticatorsViewModel();
                return authenticatorsViewModel;
            }
        }
